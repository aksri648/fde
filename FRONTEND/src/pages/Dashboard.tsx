...
import { mountUserButton, user } from "../auth/clerk";
...
export default function Dashboard() {
  ...
  let userBtnRef!: HTMLDivElement;

  onMount(() => {
    if (userBtnRef) {
      mountUserButton(userBtnRef);
    }
  });
      ...
      <div style={{ flex: 1, display: "flex", "flex-direction": "column", overflow: "hidden" }}>
        <div style={{ padding: "8px 16px", "border-bottom": "1px solid #e5e7eb", display: "flex", "justify-content": "space-between", "align-items": "center" }}>
          <h1 style={{ margin: 0, "font-size": "16px", "font-weight": 600 }}>
            FDE Desktop
            <Show when={user()}>
              <span style={{ "font-weight": 400, color: "#6b7280", "margin-left": "8px", "font-size": "13px" }}>
